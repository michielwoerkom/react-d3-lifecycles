...
function (_React$Component) {
  ...
  _createClass(SideNav, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)((_cx = {}, _defineProperty(_cx, "".concat(prefix, "--side-nav"), true), _defineProperty(_cx, "".concat(prefix, "--side-nav--expanded"), isExpanded || isFocused), _defineProperty(_cx, customClassName, !!customClassName), _cx));
